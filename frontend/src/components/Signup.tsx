      ...
      <div className="flex flex-col w-1/2 pt-36 pb-20 text-white">
        ...
        <form className='flex flex-col w-full h-full items-center font-ibm font-bold'>
          ...
          <div className='flex flex-col mt-5'>
            ...
            <div className='relative'>
              <input className='h-[54px] w-[420px] rounded-xl bg-transparent border-solid border-2 pl-4 text-[18px] pr-4' placeholder='Comfirm password' type='password' />
            </div>
          </div>
          
          <Button className='mt-8 w-[420px] h-[60px] text-[22px] rounded-xl' text='Create new account' />
          <p className="text-[16px] mt-2 cursor-default"><span className="opacity-70">Already have account?</span> <span className="hover:underline cursor-pointer" onClick={() => navigate("/login")}>Login</span></p>
        </form>
      </div>
    </div>
  );
